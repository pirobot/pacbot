...
if("FALSE" STREQUAL "TRUE")
  set(fetch_navigation_SOURCE_PREFIX /tmp/binarydeb/ros-indigo-fetch-navigation-0.7.5)
  set(fetch_navigation_DEVEL_PREFIX /tmp/binarydeb/ros-indigo-fetch-navigation-0.7.5/obj-x86_64-linux-gnu/devel)
  ...
  set(fetch_navigation_INSTALL_PREFIX /opt/ros/indigo)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fetch_navigation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'fetch_navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/indigo/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${fetch_navigation_dep}_FOUND)
      find_package(${fetch_navigation_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fetch_navigation_dep} REQUIRED ${depend_list})
  endif()
